...
This demo extension adds inline parameter hints and renames source code symbols (variables) by hiding the original content and using the decorator api to show an alternative name.

The "renaming" of the symbols is done by the following two hacks:

- setting foreground color equal to background color of the original symbol
- setting letter spacing to -100em (negative) of the original symbol
- show a new symbol name by using the decorator api
